...
ePic.value.msb = 0;
ePic.value.lsb = 0;
ePic.value.bearingm = 0;
ePic.value.bearingl = 0;
ePic.value.rangem = 0;
ePic.value.rangel = 0;
ePic.value.maxm = 0;
ePic.value.maxl = 0;
ePic.value.sensord = 0;
...
ePic.set.rgbleds = zeros(4,3);

ePic.set.IRstate = zeros(1,8);
ePic.set.extension0 = zeros(1,3);
ePic.set.extension1 = zeros(1,3);
ePic.set.extension2 = zeros(1,3);
ePic.set.extension3 = zeros(1,3);
ePic.set.extension4 = zeros(1,3);
ePic.set.extension5 = zeros(1,3);
ePic.set.extension6 = zeros(1,3);
ePic.set.extension7 = zeros(1,3);
ePic.set.extension8 = zeros(1,3);
